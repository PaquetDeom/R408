...
@XStreamAlias("brasDeDeport")
@Entity
@Table(name = "BRASDEDEPORT")
...
public class BrasDeDeport extends TypeElement {

	public BrasDeDeport() {
		super();
	}

	public BrasDeDeport(String name, String ref, Constructeur cons, double poids, TypeEchaf tE) {
