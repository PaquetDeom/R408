...
@XStreamAlias("embase poteaux")
@Entity
@Table(name = "EMBASEPOTEAUX")
...
public class EmbasePoteaux extends TypeElement {
	
	public EmbasePoteaux() {
		super();
	}

	public EmbasePoteaux(String name, String ref, Constructeur cons, double poids, TypeEchaf tE) {
