...
public class Plinthe extends TypeElement {
	...
	public Plinthe(String name, String ref, Constructeur cons, double poids, TypeEchaf tE, double longueur) {
