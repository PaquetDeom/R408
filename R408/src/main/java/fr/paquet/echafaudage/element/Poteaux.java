...
public class Poteaux extends TypeElement {
	...
	public Poteaux(String name, String ref, Constructeur cons, double poids, TypeEchaf tE, double longueur) {
