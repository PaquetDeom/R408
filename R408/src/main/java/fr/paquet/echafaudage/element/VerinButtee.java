...
@XStreamAlias("verin de buttée")
@Entity
@Table(name = "VERINBUTTEE")
...
public class VerinButtee extends TypeElement{
	
	public VerinButtee() {
		super();
	}

	public VerinButtee(String name, String ref, Constructeur cons, double poids, TypeEchaf tE) {
