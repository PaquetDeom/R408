...
public final class SwtBrowserCanvas extends Canvas {
	 ...
	 * <p>
	 * <a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=161911">SWT Component
	 * Not Displayed Bug</a>
	 */
	static {
	 ...
	 * <p>
	 * This must be called <strong>after</strong> the parent application Frame is
	 * made visible - usually directly after <code>frame.setVisible(true)</code>.
	 * <p>
	 ...
	 *
	 * @return <code>true</code> if the browser component was successfully created;
	 *         <code>false if it was not</code/
	 */
	...
	private class SwtThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				// -
				// there is a theoretical (rare) chance of failure to initialise the SWT
				// components
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (browserCanvas.initialise()) {
				...
				browserCanvas.setUrl("https://www.google.com");
			} else {
